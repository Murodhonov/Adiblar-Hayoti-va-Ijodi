...
import uz.umarxon.adiblar.databinding.FragmentUzbekAdabiyotBinding
import uz.umarxon.adiblar.models.AdibClass

class UzbekAdabiyotFragment : Fragment() {

    lateinit var binding: FragmentUzbekAdabiyotBinding
    lateinit var list:ArrayList<AdibClass>
    lateinit var firebaseFirestore: FirebaseFirestore

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = FragmentUzbekAdabiyotBinding.inflate(layoutInflater)
